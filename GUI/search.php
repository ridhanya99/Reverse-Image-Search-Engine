...
<body>
	...
	<h3 >Input Search Term:</h3>
            ...
            <?php
				...
				//exec("C:/Python/Python38/python3.exe D:/XAMPP/htdocs/text_retrieval.py");
				$command = escapeshellcmd('python3 D:/XAMPP/htdocs/Package/Image_Retrieval/text_retrieval.py');
